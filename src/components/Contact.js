...
const validEmail = (val) => /^[A_Z0-9._%+-]+@[A_Z0-9.-]+\.[A-Z]{2,4}$/i.test(val);
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".firstname" id="firstname" name="firstname"
                                        ...
                                        validators={{required, minLengthf: minLength(3), maxLength: maxLength(15)}}
                                         />
                                    <Errors className="text-danger" model=".firstname" show="touched"
                                    messages={{required: "Required", minLength:"Must be greater than 3 characters", maxLength: "Must be less than 15 characters"}}/>
                                </Col>
                            </Row>
                            ...
                            <Label htmlFor="telnum" md={2}>Contact Tel.</Label>
                                <Col md={10}>
                                    <Control.text model=".telnum" id="telnum" name="telnum"
                                        ...
                                        model=".lastname" show="touched" messages={{
                                            required:"Required", minLength: "Must be greater than 3 charachers",
